...
{
	private const PATTERN = "/(\d{1,2}\/\d{1,2}\/\d{1,4})\s-\s(\d{1,2}:\d{1,2}:\d{1,2}):\sYour server is out of date and will be shutdown during hibernation or changelevel, whichever comes first./i";
